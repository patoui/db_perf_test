...
docker exec -w /tmp/data mysql57 mysql -uroot -ppassword -Demployees -e "LOAD DATA INFILE '/tmp/data/salaries1.tsv' INTO TABLE salaries FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 LINES;"
docker exec -w /tmp/data mysql57 mysql -uroot -ppassword -Demployees -e "LOAD DATA INFILE '/tmp/data/salaries2.tsv' INTO TABLE salaries FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 LINES;"
